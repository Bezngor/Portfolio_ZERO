...
agent = TextAgent(model="claude-sonnet-4-5-20250929")  # или "gpt-4.1-mini-2025-04-1"
...
**Выбор модели:**
- Обычная модель (gpt-4.1-mini-2025-04-1) - быстрые ответы
...
- Выбор между двумя моделями: GPT-4.1 Mini (быстрая) и Claude Sonnet 4.5 (качественная)
