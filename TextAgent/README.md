...
agent = TextAgent(model="claude-sonnet-4-5-20250929")  # или "gpt-5-mini-2025-08-07"
...
**Выбор модели:**
- Обычная модель (gpt-5-mini-2025-08-07) - быстрые ответы
...
- Выбор между двумя моделями: GPT-5 Mini (быстрая) и Claude Sonnet 4.5 (качественная)
